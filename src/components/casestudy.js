          ...
          {slides.map((slide) => (
            <div key={slide.id} className="case-slide">
              ...
              <div className="case-slide-content">  
                ...
                <div className="case-slide-impact" style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                  <span>Impact:</span>
                  <ul>
                    {slide.impact.map((point, index) => (
                      <li style={{ justifyContent: 'left' }} key={index}>{point}</li>
                    ))}
                  </ul>
                </div>
              </div>
